...
import { deleteTestimonial } from '../../Commonapicall/settingsapicall/Testimonialapicall';
...
export const DeleteTestimonialPopup: React.FC<DeleteJobPostingPopupProps> = ({
  closePopup,
  TestimonialData,
  refreshData
}) => {
  ...
  const handleAgentDelete = async () => {
    ...
    try {
      const success = await deleteTestimonial(TestimonialData.id);
      if (success) {
        closePopup();
        refreshData();
      ...
      <div className="container mx-auto">
        <div className="relative bg-white rounded-[5px] w-4/12 mx-auto px-5 py-5">
          <div className="relative mb-10">
            <h2 className="text-2xl text-armsBlack font-semibold pb-3 border-b-2 border-armsgrey ">Delete Testimonial</h2>
